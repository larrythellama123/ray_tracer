...
//     // if (Frame == 0) {
//     //     finalColor = currentRayColor;
//     // } else {
//     //     finalColor = accumulatedColor + currentRayColor;
//     // }
//     // float weight = 1.0f / (Frame + 1);
//     // // vec3 outputColor = accumulatedColor.rgb * (1 - weight) + currentRayColor.rgb * weight;
//     // vec3 outputColor = accumulatedColor.rgb * (weight) + currentRayColor.rgb * (1-weight);

//     // vec4 finalColor = vec4(outputColor,1.0f);

//     // // finalColor = accumulatedColor + vec4(0.05, 0.0, 0.0, 0.0);
...
//     } else {
//         FragColor = accumulatedColor;  // Should stay red if texture is working
//     }
...
//     material4.emissionStrength =10.0f;
//     material4.smoothness=1.0f;
//     material4.specularProbability=1.0f;
//     material4.flag = LIGHT_SOURCE;

//     Sphere sphere4(30,30, glm::vec3(-50.0f,-0.0f,-7.0f),material4, 30.0f);
...
//     // Now bind the framebuffer we're writing to
//     glBindFramebuffer(GL_FRAMEBUFFER, fbos[currentWriteBuffer]);
...
//             std::cerr << "Framebuffer " << i << " incomplete: " << status << std::endl;
//         }
//     }
    
//     // IMPORTANT: Unbind everything
